...
<head>
    ...
    <title>Hillcrest High - INFT Teacher Portfolio </title>
...
<body>
    ...
    <header>
        <h1>Hillcrest High - INFT Teacher Portfolio </h1>
        <img src="./portfolio/images/self.jpg" alt="Photo">
    </header>
    <main>
        <section>
            <div>
            <p>Please note that the following is a portfolio item, used to demonstrate skills gained in Delphi 2010</p>    
            </div>
        </section>
    </main>
    <footer>
